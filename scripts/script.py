...
@hydra.main(config_path = "scripts/conf", config_name = "main_config", version_base='1.2')
def main(cfg):
    ...
    if cfg.setup_dict:
        for i in range(1, 4):
            ...
            setup_dict(path, batches, cfg.env_config.batch, exp_id, native_list, cfg.env_config.seed)
